...
if (isset($_POST["login"])) {
    ...
    // Pastikan 'akun' dipilih agar tidak terjadi error
    $akun = $_POST["akun"] ?? '';
    ...
    if ($akun == 'agen') {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if (password_verify($password, $row["password"])) {
                ...
                echo "<script>Swal.fire('Gagal Login','Password Yang Anda Masukkan Salah','warning');</script>";
            }
        } else {
            echo "<script>Swal.fire('Gagal Login','Email Belum Terdaftar','warning');</script>";
        }
        ...
        if (mysqli_num_rows($data) === 1) {
            ...
            echo "<script>Swal.fire('Gagal Login','Username Tidak Terdaftar Sebagai Admin','warning');</script>";
        }
    } else {
