    ...
    <div class="container">
        <div class="row">
            ...
            <p class="grey-text text-lighten-4">
                LaundryKu adalah sebuah projek yang ditujukan sebagai tugas ukom yang dikerjakan untuk lulus ujian
            </p>
            ...
            <ul>
                ...
                <li><a class="white-text" href="team.php">DONS PABLOZ</a></li>
